  ...
  <div class="w-full max-w-md p-8 space-y-8 card rounded-xl shadow-lg">
    ...
    <div class="mt-8 space-y-6">
      <button 
        ...
        disabled={loading}
        class="w-full flex items-center justify-center py-3 px-4 rounded-md shadow-sm accent_color_button hover:bg-gray-50 text-gray-700 font-medium hover:scale-105"
      >
