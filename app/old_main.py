...
btnSaveToFile = customtkinter.CTkButton(
    ctk, text="Save To File", font=("Helvetica", 60), command=lambda: save_weight(1, name.get(), float(weight_TKvar.get()), person_type.get())
)
...
label1 = customtkinter.CTkLabel(
    ctk, textvariable=f"{weight_TKvar} lbs.", font=("Helvetica", 200), width=100
)
